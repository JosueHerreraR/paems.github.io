<?php
    ...
    $consulta = "SELECT * FROM datos_escuelas INNER JOIN redes_sociales INNER JOIN imagenes_escuelas WHERE id_red_social = '2' and  id_escuela = '2' and id_img = '2'";
