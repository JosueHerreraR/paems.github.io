<?php
    ...
    $consulta = "SELECT * FROM datos_escuelas INNER JOIN redes_sociales INNER JOIN imagenes_escuelas WHERE id_red_social = '3' and  id_escuela = '3' and id_img = '3'";
    ...
    <body>
        ...
        <section class="subhero" id="subhero">
            <div class="container-img">
                <img src="/Sistema_Feria/fotos-logos/<?php echo $ruta_logo?>" alt="Imagen del logo escolar">
            </div>
